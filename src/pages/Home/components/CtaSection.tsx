...
const CtaSection: React.FC<CtaSectionProps> = ({
  ...
  return <section ref={bottomSectionRef} className="py-16 md:py-32 px-4 md:px-0 bg-gradient-to-b from-background to-muted">
      <div className="rfp-container text-center">
        <h2 className="font-heading mb-6 md:mb-8">Begin Your Transformation Journey</h2>
